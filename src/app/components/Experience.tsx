      ...
      {experiences.map((exp, index) => (
        ...
        >
          <div className="flex-1">
            ...
            {exp.company && (
              <p className="text-[#C6F368] font-medium text-sm sm:text-base mb-2">{exp.company}</p>
            )}
            <p className="text-[#C7C7C7] max-w-full md:max-w-xl text-sm sm:text-base leading-relaxed">{exp.description}</p>
          </div>
